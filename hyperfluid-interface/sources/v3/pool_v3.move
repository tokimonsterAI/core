module dex_contract::pool_v3 {
    ...
    use aptos_framework::object::{Self, Object, ExtendRef, convert};
    ...
    const NAME: vector<u8> = b"pool_v3";
    ...
    public fun create_pool(
        ...
        let object = object::create_object(@dex_contract);
        let signer_obj = object::generate_signer(&object);
        move_to(&signer_obj, LiquidityPoolV3 {
            num_ticks: 0
        });
        object::object_from_constructor_ref<LiquidityPoolV3>(&object)
    }
